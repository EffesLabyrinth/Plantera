...
public class newPlantTriggerBamboo : MonoBehaviour
{
    ...
    void UnlockPlant()
    {
        PlayEventManager.instance.TriggerOnGoToEvent("Quest4Pokok");
        PlayerManager.instance.playerStat.unlockedPlant[2] = true;
